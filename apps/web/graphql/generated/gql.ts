 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query vendingMachines($limit: Int, $sort: SortEnum, $status: OpenStatus, $offset: Int) {\n  vendingMachines(limit: $limit, sort: $sort, status: $status, offset: $offset) {\n    total\n    nodes {\n      id\n      name\n      description\n      currentSales\n      lastBoots\n      logs {\n        title\n        description\n      }\n      status\n      statusMessage\n      config {\n        temperature\n        stockThresholds\n        operationalHours {\n          start\n          stop\n        }\n      }\n    }\n  }\n}"): (typeof documents)["query vendingMachines($limit: Int, $sort: SortEnum, $status: OpenStatus, $offset: Int) {\n  vendingMachines(limit: $limit, sort: $sort, status: $status, offset: $offset) {\n    total\n    nodes {\n      id\n      name\n      description\n      currentSales\n      lastBoots\n      logs {\n        title\n        description\n      }\n      status\n      statusMessage\n      config {\n        temperature\n        stockThresholds\n        operationalHours {\n          start\n          stop\n        }\n      }\n    }\n  }\n}"];
