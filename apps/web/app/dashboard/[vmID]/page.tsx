...
export default function DashboardPage({
  ...
  return (
    <>
      ...
      <hr className="m3-10" />
      <div className="p-10 max-w-screen-lg mx-6 md:mx-auto bg-white mt-10 rounded-md shadow-md border border-gray-100 space-y-3">
        <div className="mb-6">
        ...
        <div className="grid md:grid-cols-2">
          <div>
            ...
            <p className="text-lg">{vendingMachineData?.config.temperature}</p>
          </div>
          <div className="">
